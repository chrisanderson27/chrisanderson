...
console.log(imageBlock.value + ' === ' + this.truthChecker );
  ...
  populateImageData() {
    ...
    // switch (randomNum) {
    //   case 0:
    //     myImageData.name = 'bird';
    //     myImageData.url = this.sourceList[0];
    //     myImageData.value = myImageData.name === this.control ? true : false;
    //     break;
    //   case 0:
    //     myImageData.name = 'bird';
    //     myImageData.url = this.myImageUrls[0];
    //     myImageData.value = myImageData.name === this.control ? true : false;
    //     break;
    //   case 0:
    //     myImageData.name = 'bird';
    ...
    //     break;
    //   case 1:
    //     myImageData.name = 'green';
    //     myImageData.url = this.myImageUrls[1];
    //     myImageData.value = myImageData.name === this.control ? true : false;
    //     break;
    //   case 2:
    //     myImageData.name = 'red';
    //     myImageData.url = this.myImageUrls[2];
    //     myImageData.value = myImageData.name === this.control ? true : false;
    //     break;
